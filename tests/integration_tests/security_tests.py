...
class TestRolePermission(SupersetTestCase):
    ...
    def test_views_are_secured(self):
        ...
        views_allowlist = [
            ...
            ["ChartRestApi", "get_dashboard_charts"],
            ["ChartRestApi", "get_public_charts"],
            ["ChartDataRestApi", "get_dashboard_charts"],
            ["ChartDataRestApi", "get_public_charts"],
            ["ChartDataRestApi", "get_public_data"],
            ["DashboardRestApi", "get_public_dashboard"],
            ["DashboardRestApi", "get_public_dashboards"],
            ["DashboardRestApi", "get_public_entry_dashboard"],
            ["DatabaseRestApi", "dhis2_chart_data"],
            ["DatabaseRestApi", "dhis2_expanded_org_units"],
            ["DatabaseRestApi", "dhis2_metadata_public"],
            ["DatabaseRestApi", "dhis2_preview_columns"],
            ["DatabaseRestApi", "dhis2_preview_data"],
            ["DHIS2BoundariesRestApi", "clear_cache"],
            ["DHIS2BoundariesRestApi", "get_boundaries"],
            ["DHIS2BoundariesRestApi", "get_cache_status"],
            ["PublicPageRestApi", "download_asset"],
            ["PublicPageRestApi", "get_available_charts"],
            ["PublicPageRestApi", "get_config"],
            ["PublicPageRestApi", "get_navigation"],
            ["PublicPageRestApi", "get_page_layout"],
            ["PublicPageRestApi", "get_pages"],
            ["PublicPageRestApi", "get_portal"],
            ["PublicPageRestApi", "indicator_highlights"],
            ["PublicExploreView", "public_explore"],
            ["Superset", "public_landing"],
            ["PublicSecurityRestApi", "guest_token_proxy"],
            ["PublicSecurityRestApi", "public_guest_token"],
        ]
        unsecured_views = []
