# DELIVERY-RULES.md
## Delivery Rules for Codex Agent
...
7. Do not leave chart querying dependent on live sources by default for staged datasets.
8. Do not discard source lineage at any stage.
9. Do not merge data from different sources without explicit lineage.
...
21. The local staging framework must remain generic enough to support DHIS2 and other supported Superset sources.
